...
```bash
curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/laohuyou886/ip-deploy/main/run_ip-collector.sh | bash -s -- --upload http://10.10.89.113:8080/upload
```
